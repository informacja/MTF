...
% ................ #Wybor typu filtru .......................
typMTF=[5 5 5 3]; %[3 3 5 3]; % typ filtru: 3 - Z1 - filtr koncowy zwykly; 5 - z3 - trend 3.go rzƒôdu 
...
for(nrs=1:Lgestow)  %2:2) % Petla po szeregach
    ...
    for(nosoby=nOs1:dno:nOsf)
        ...
        for(wgEn=0:LwgE)
            ...
            % ----------- Okreúlenie zakresu lT analizy widm (tak aby dobrze sprÛbkowaÊ widmo) 
...
%% ================= Sprawdzenie filtracji Fzwdc: yTrc wg Fzwdc, yTr - metodπ dwuetapowπ Fzwd i Fzw2 ============  
m=1; yTrc=[];for(n=Lzwc:Nf) yTrc(m)=Yoryg(n-Lzwc+1:n)'*Fzwc; m=m+1; end
figure(2); subplot(1,1,1); plot(nY1Tr:nYfTr, yTrc,'r',nY1Tr:nYfTr, yTr,'k'); axis('tight');
